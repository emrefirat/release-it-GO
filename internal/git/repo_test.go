...
func TestParseRepoURL(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			wantRepo:   "myproject",
			wantRemote: "https://gitlab.com/group/subgroup/myproject",
		},
		{
			name:      "GitLab nested group SSH",
		...
		{
			name:       "GitLab deeply nested HTTPS",
			url:        "https://gitlab.com/a/b/c/repo.git",
			wantProto:  "https",
			wantHost:   "gitlab.com",
			wantOwner:  "a/b/c",
			wantRepo:   "repo",
			wantRemote: "https://gitlab.com/a/b/c/repo",
		},
		{
			name:      "GitLab deeply nested SSH",
			url:       "git@gitlab.com:a/b/c/repo.git",
			wantProto: "ssh",
			wantHost:  "gitlab.com",
			wantOwner: "a/b/c",
			wantRepo:  "repo",
		...
		{
			name:       "Nested group with credentials",
			url:        "https://oauth2:token@gitlab.example.com/org/team/project.git",
			wantProto:  "https",
			wantHost:   "gitlab.example.com",
			wantOwner:  "org/team",
			wantRepo:   "project",
			wantRemote: "https://gitlab.example.com/org/team/project",
		},
		{
		...
		{
			name:      "SSH URL with port and nested group",
			url:       "ssh://git@gitlab.example.com:2222/group/sub/repo.git",
			wantProto: "ssh",
			wantHost:  "gitlab.example.com",
			wantOwner: "group/sub",
			wantRepo:  "repo",
